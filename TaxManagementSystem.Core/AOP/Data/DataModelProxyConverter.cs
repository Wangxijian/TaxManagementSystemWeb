namespace TaxManagementSystem.Core.AOP.Data
{
    using TaxManagementSystem.Core.ValueType;
    using System;
    ...
    public sealed partial class DataModelProxyConverter
    {
        ...
        {
            AssemblyName assemblyName = new AssemblyName("TaxManagementSystem.Aop.Dynamic");
